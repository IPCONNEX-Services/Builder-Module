...
- Keep Frappe UI out of dependency prebundling so its virtual icons go through the Vite plugin. CI also smoke-tests development startup and an icon module.
